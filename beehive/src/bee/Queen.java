...
public class Queen extends Bee {
    ...
    //private QueensChamber queen;
    int newBees;
    public static int no_of_child;
    ...
    public void run() {
        ...
        System.out.println("*Q* Queen birthed "+no_of_child+" children");
